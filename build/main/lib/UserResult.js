 ...
 * user.mainPsychoTypeList // массив числовых значений (поле index) основных октант пользователя. Максимальная + те, которые не менее чем на  20% отличаются от нее по полю value. Опциональный параметр diff (default = .2)
 * user.mainTendencyList // массив числовых значений (поле index) основных тенденций пользователя. Максимальная + те, которые не менее чем на  20% отличаются от нее по полю value. Опциональный параметр diff (default = .2)
 * ```
 * @param testResult
